...
```{r selectdrop, exercise=TRUE, exercise.lines = 5}
pinksalmonratio %>% select(-)
```
...
```{r mutate-comment, exercise=TRUE, exercise.lines = 5}
...
```{r mutatenew, exercise=TRUE, exercise.lines = 5}
...
```{r mutate-weight, exercise=TRUE, exercise.lines = 5}
...
```{r mutate-if, exercise=TRUE, exercise.lines = 5}
